        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="text-center">
                    <img src='{{asset('recursos/sinportada.png')}}' class='avatar img-thumbnail' alt='imagen' width='165' height='auto'>
            ...
            <div class="col-md-8 col-sm-6 col-xs-12 personal-info">
                ...
                <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            {!! Form::number('precio', '0.00', ['class'=>'form-control', 'required', 'step'=>'0.01', 'min'=>'0.00', 'value'=>'0.00','placeholder'=>'0.00'])!!}
                        </div>
                </div>
                {{-- Tipo --}}
                <div class="form-group">
